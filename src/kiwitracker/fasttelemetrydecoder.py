...
class FastTelemetryDecoder:
    ...
    def send(self, bpm):
        ...
        if value in [FastTelemetryMode.Mortality, FastTelemetryMode.Nesting, FastTelemetryMode.NotNesting, FastTelemetryMode.Hatch, FastTelemetryMode.DesertionAlert]:
